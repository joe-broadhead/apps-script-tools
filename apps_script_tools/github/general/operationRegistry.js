const AST_GITHUB_OPERATION_REGISTRY = Object.freeze({
  ...
  get_pull_request_comments: Object.freeze({ method: 'get', path: request => astGitHubBuildPullIssueCommentsPath(request), read: true, paginated: true, group: 'pull_requests' }),
